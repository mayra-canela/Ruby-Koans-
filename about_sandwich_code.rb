...
class AboutSandwichCode < EdgeCase::Koan
  ...
  def test_counting_lines
    assert_equal 5, count_lines("example_file.txt")
  end
  ...
  def test_counting_lines2
    assert_equal 5, count_lines2("example_file.txt")
  end
  ...
  def test_finding_lines2
    assert_equal 5, find_line2("example_file.txt")
  end
  ...
  def test_open_handles_the_file_sandwich_when_given_a_block
    assert_equal 5, count_lines3("example_file.txt")
  end
